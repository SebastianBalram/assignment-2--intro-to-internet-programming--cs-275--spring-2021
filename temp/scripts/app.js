...
function WhiteRiceRecipe() {
  document.getElementById("WhiteRice").innerHTML = "Combine 1 cup of rice with 2 cups of water and 1 Tbsp olive oil. Bring to a boil, then reduce heat to the lowest setting. Cook for about 18 minutes.";
}

function SproutRecipe() {
  document.getElementById("SproutRice").innerHTML = "For slightly al dente rice:";
...
window.onload = function () {// Add active class to the current button (highlight it)
};